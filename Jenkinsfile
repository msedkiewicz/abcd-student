            ...
            steps {
                ...
                sh '''
                    docker run --name zap \
                        ...
                        "zap.sh -cmd -addonupdate; zap.sh -cmd -addoninstall communityScripts -addoninstall pscanrulesAlpha -addoninstall pscanrulesBeta -autorun /mnt/zap/wrk/passive.yaml" \
                        || true
                '''
            }
            post {
